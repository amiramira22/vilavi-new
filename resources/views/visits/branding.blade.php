    ...
    <div class="col-md-9">
        <div class="m-portlet m-portlet--full-height m-portlet--tabs  ">
            <div class="tab-content">
                ...
                if (($row->new_branding_pictures != '') && ($row->new_branding_pictures != '[]')) {
                    $new_one_pictures = json_decode($row->new_one_pictures, TRUE);
                    $new_branding_pictures = json_decode($row->new_branding_pictures, TRUE);
                    ?>
                    <div id="carouselExampleIndicators<?php echo $row->id ?>" class="carousel slide" data-ride="carousel">
                        ...
                        <ol class="carousel-indicators">
                            ...
                            <?php
                            $size_pictures = sizeof($new_branding_pictures);
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                ...
                                <table>
                                    <tr>
                                        <td width="5%"></td>
                                        <td width="100%">
                                            <img width="700px" height="350px" src="{{'https://'.env('project_name').'.cap.tn/uploads/outlet/'. $row->outlet_picture}}"  >
                            ...
                            <div class="carousel-item">
                                ...
                                <table>
                                        ...
                                        <tr>
                                            <td width="5%"></td>
                                            <td width="50%"><span><img src="{{'https://'.env('project_name').'.cap.tn/uploads/branding/'. $new_branding_pictures[0][0]}}" width="300px" height="350px" alt="admin-pic" download></span></td>
                                            <td width="5%"></td>
                                            <td width="50%"> <span><img src="{{'https://'.env('project_name').'.cap.tn/uploads/branding/'. $new_branding_pictures[0][1]}}" width="300px" height="350px" alt="admin-pic" download></span></td>
                                            <td width="5%"></td>
                                        </tr>
                            ...
                            for ($i = 1; $i < $size_pictures; $i++) {
                                ...
                                <div class="carousel-item">
                                    <table>
                                            ...
                                            <tr>
                                                <td width="5%"></td>
                                                <td width="50%"><span><img src="{{'https://'.env('project_name').'.cap.tn/uploads/branding/'.$new_branding_pictures[$i][0]}}" width="300px" height="350px" alt="admin-pic" download></span></td>
                                                <td width="5%"></td>
                                                <td width="50%"> <span><img src="{{'https://'.env('project_name').'.cap.tn/uploads/branding/'. $new_branding_pictures[$i][1]}}" width="300px" height="350px" alt="admin-pic" download></span></td>
                                                <td width="5%"></td>
                                            </tr>
