        ...
        <div class="m-portlet__body">
            <div class="tab-content">
                ...
                <div class="tab-pane " id="m_portlet_tab_2_2">
                    <?php
                    if (($visit->new_branding_pictures != '') && ($visit->new_branding_pictures != '[]')) {

                    $new_branding_pictures = json_decode($visit->new_branding_pictures, TRUE);
                    $brandings = $visit->new_branding_pictures;
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi">
                                ...
                                <div class="m-portlet__body">
                                    ...
                                    <img src="{{'https://'.env('project_name').'.cap.tn/uploads/branding/'. $brandings[$i][0]}}" alt="admin-pic"
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi">
                                ...
                                <div class="m-portlet__body">
                                    <center>
                                        <img src="{{'https://'.env('project_name').'.cap.tn/uploads/branding/'. $brandings[$i][1]}}" alt="admin-pic"
                                             download width="450px" height="400px">
                                    </center>
                                </div>
                            </div>
                ...
                <div class="tab-pane " id="m_portlet_tab_2_3">
                    ...
                    <?php
                    if (($visit->new_one_pictures != '') && ($visit->new_one_pictures != '[]')) {
                    $new_one_pictures = json_decode($visit->new_one_pictures, TRUE);
                    ?>
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        <ol class="carousel-indicators">
                            <li data-target="#carouselExampleIndicators" data-slide-to="0" class="active"></li>
                            <?php
                            for ($i = 1; $i < sizeof($new_one_pictures); $i++) {
                            ?>
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <center>
                                    ...
                                    <img src="{{'https://'.env('project_name').'.cap.tn/uploads/branding/'. $new_one_pictures[0]}}"
                                         alt="admin-pic"
                            ...
                            <div class="carousel-item">
                                <center>
                                    <img src="{{'https://'.env('project_name').'.cap.tn/uploads/branding/'. $new_one_pictures[$i]}}"
                ...
                <div class="tab-pane " id="m_portlet_tab_2_4">
                    ...
                    //                    $pointing = json_decode($visit->new_one_pictures, TRUE);
                    $pointing = $visit->photos;
                    ?>
                    <center><img src="{{ 'https://'.env('project_name').'.cap.tn/uploads/pointing/'. $pointing}}" alt="" id=""
