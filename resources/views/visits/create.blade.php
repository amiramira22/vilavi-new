...
<div class="m-portlet m-portlet--full-height">
    ...
    <div class="m-wizard">
        ...
        <div class="m-wizard__form">
            ...
            {!! Form::open(['url' => 'brand/postBrand', 'method' => 'post', 'class' => 'm-form m-form--label-align-left- m-form--state-', 'enctype' => 'multipart/form-data']) !!}
            <!--begin: Form Body -->
                ...
                <div class="m-form__actions">
                    <div class="row">
                        ...
                        <div class="col-lg-4 m--align-right">
                            ...
                            <button class="btn btn-warning m-btn m-btn--custom m-btn--icon" type="submit">
