                ...
                <div class="m-card-profile">
                    ...
                    <div class="m-card-profile__pic">
                        <div class="m-card-profile__pic-wrapper">
                            ...
                            <img src="https://hcm.capesolution.tn/uploads/users/{{$user->photos}}" alt="">
                            @else 
        ...
        <div class="m-portlet m-portlet--full-height m-portlet--tabs  ">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="update_profile_tab_<?php echo $user->id; ?>">
                    <!--begin::Form-->	
                    {!! Form::model($user, ['route' => ['admin.fo_report.update', $user->id], 'method' => 'put', 'class' => 'm-form m-form--label-align-righ', 'enctype' => 'multipart/form-data']) !!}	
