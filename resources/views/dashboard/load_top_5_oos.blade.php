                ...
                <script type="text/javascript">
                    ...
                    $("#<?php echo 'top_' . $date_this_week; ?>").click(function () {
                        ...
                        jQuery.ajax({
                            ...
                            url: '<?= route('dashboard.load_top_oos_products') ?>',
                    ...
                    <table class="table m-table m-table--head-bg-{{env('tableColor')}}">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td></td>
                                <td></td>
                                <td><b><a class="m--font-red" href="<?php echo url('dashboard/top_oos_all_products/' . $date_this_week); ?>" target="_blank">view all</a></b></td>
                            </tr> 
                        </tbody>
                    </table>
