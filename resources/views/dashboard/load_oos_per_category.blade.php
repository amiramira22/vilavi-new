<div class="m-portlet m-portlet--tabs">
        ...
        <div class="m-portlet__head-tools">
            <ul class="nav nav-tabs m-tabs m-tabs-line m-tabs-line--right m-tabs-line--danger" role="tablist">
                ...
                <li class="nav-item m-tabs__item">
                    <a href="#tab_category<?php echo $brand_cat->id; ?>"
                       id="brand_cat<?php echo $brand_cat->id; ?>"
                ...
                <script type="text/javascript">
                    ...
                    $("#<?php echo 'brand_cat' . $brand_cat->id; ?>").click(function () {
                        ...
                        $('#chartdiv_category_<?php echo $brand_cat->id; ?>').html('<div class="col-md-12" align="center"><img width="120px" src="<?php echo asset('img/plus-loader.gif'); ?>" class="img-responsive img-center" /></div>');

                        jQuery.ajax({
                            url: '<?= route('dashboard.load_chart_oos_per_category') ?>',
                            data: {_token: CSRF_TOKEN, brand_id: "<?php echo $brand_cat->id; ?>"},
                            type: "POST",
                            success: function (data) {
                                $('#chartdiv_category_<?php echo $brand_cat->id; ?>').html(data);
                            }
                        });
                    });
    ...
    <div class="m-portlet__body">
        <div class="tab-content">
            ...
            ?>
            <style>
                #chartdiv_category_<?php echo $brand_cat->id; ?>  {
                    width: 90%;
                    height: 400px;
                }

            </style>
            <div class="tab-pane <?php echo $class; ?>" id="tab_category<?php echo $brand_cat->id; ?>">
                <div id="chartdiv_category_<?php echo $brand_cat->id; ?>"
                     name="chartdiv_category_<?php echo $brand_cat->id; ?>"></div>
            </div>
            <!--   tab1 content-->
            <?php } ?>
        </div>
