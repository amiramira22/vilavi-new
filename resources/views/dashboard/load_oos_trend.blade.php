        ...
        <div class="m-portlet__head-caption">
            <div class="m-portlet__head-title">
                <h3 class="m-portlet__head-text text-danger">
                    ...
                    <i class="flaticon-graph text-danger"></i>
        ...
        <div class="m-portlet__head-tools">
            <ul class="nav nav-tabs m-tabs m-tabs-line m-tabs-line--right m-tabs-line--danger" role="tablist">
                <script type="text/javascript">
                        $('#trend_div_1').html('<div class="col-md-12" align="center"><img width="120px" src="<?php
                            echo asset('img/plus-loader.gif'); ?>" class="img-responsive img-center" /></div>');
                        jQuery.ajax({
                            url: '<?= route('dashboard.load_chart_oos_trend') ?>',
                            data: {_token: CSRF_TOKEN, category_id: "1"},
                            type: "POST",
                            success: function (data) {
                                $('#trend_div_1').html(data);
                            }
                        });
