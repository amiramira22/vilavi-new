...
// Adjust to Thursday in week 1 and count number of weeks from date to week1.
    ...
    <div class="m-portlet m-portlet--tab">
        ...
        <!--begin::Form-->
        {!! Form::open(['url' => 'report/numeric_distribution', 'method' => 'post', 'class' => 'm-form m-form--fit m-form--label-align-right','autocomplete'=>'off' ]) !!}
        ...
        <div class="form-group m-form__group row">
            ...
            <div class="col-lg-4 col-md-9 col-sm-12">
                {!! Form::select('date_type', $date_types , $date_type ,
['class' => 'form-control ','id'=>'date_type']) !!}
        ...
        <div class="form-group m-form__group row" id="month">
            ...
            <div class="col-lg-4 col-md-9 col-sm-12">
                <div class="input-group date">
                    {!! Form::text('end_date', format_qmw_date($date_type, $end_date),
['class' => 'form-control m-input', 'placeholder' => 'End Date','id'=>'datepicker_m2']) !!}
        ...
        <div class="form-group m-form__group row" id="week">
            ...
            <div class="col-lg-4 col-md-9 col-sm-12">
                <div class="input-group date">
                    ...
                    {!! Form::hidden('end_date_w', format_qmw_date($date_type, $end_date),
['class' => 'form-control m-input', 'placeholder' => 'Start Date','id'=>'datepicker_w2_alt']) !!}
        ...
        <div class="form-group m-form__group row" id="quarter">
            ...
            <div class="col-lg-4 col-md-9 col-sm-12">
                <div class="input-group">
                    ...
                    {!! Form::select('quarter1', $quarter_dates ,'$quarter1',
['class' => 'form-control']) !!}
            ...
            <div class="col-lg-4 col-md-9 col-sm-12">
                <div class="input-group">
                    ...
                    {!! Form::select('quarter2', $quarter_dates ,'$quarter2',['class' =>
 'form-control']) !!}
    ...
    @if($date_type && $start_date && $end_date)
        @if ($multi_date && !$multi_zone && !$multi_channel)
            @include('report.numeric_distribution.multi_date.multi_date');

        @elseif  ($multi_date && $multi_zone)
            @include('report.numeric_distribution.multi_date.multi_date_zones');

        @elseif  ($multi_date && !$multi_zone && $multi_channel)
            @include('report.numeric_distribution.multi_date.multi_date_channels');

        @elseif  (!$multi_date && !$multi_zone && !$multi_channel)
            @include('report.numeric_distribution.single_date.single_date');

        @elseif  (!$multi_date && $multi_zone)
            @include('report.numeric_distribution.single_date.single_date_zones');

        @elseif  (!$multi_date && $multi_channel)
            @include('report.numeric_distribution.single_date.single_date_channels');
