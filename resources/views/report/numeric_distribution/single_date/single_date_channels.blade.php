            ...
            <div class="m-section__content">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover" id="data_table">
                        ...
                        <?php
                        $i = 0;
                        foreach ($components as $brand_id => $componentchannels) {
                        $i++;
                        ?>
                        <tr>
        ...
        <div class="m-section">
            <div class="m-section__content" id="content_cluster<?php echo $cluster_id; ?>-1">
                <script type="text/javascript">
                    ...
                    jQuery.ajax({
                        type: 'post',
                        url: '<?= route('report.load_av_cluster_channels') ?>',
                        data: {
                            _token: CSRF_TOKEN,
...
<div class="m-portlet">
    ...
    <div class="m-portlet__body">
        ...
        <div class="m-section">
            <div class="row">
                <div class="m-section__content" style="height:400px; width:25%;"></div>
                <div class="m-section__content" style="height:400px; width:50%;"
                     id="chart_channel<?php echo $channel; ?>"></div>
                <div class="m-section__content" style="height:400px; width:25%;"></div>
            </div>
        </div>
    </div>
...
<script>
    ...
    show_bar_chart_per_channel(data_av, data_oos, data_ha, "chart_channel<?php echo $channel; ?>");

    function show_bar_chart_per_channel(data_av, data_oos, data_ha, container) {
        // Create the chart
