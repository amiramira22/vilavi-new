...
@section('content')
    ...
    <div class="m-portlet m-portlet--tab">
        ...
        <!--begin::Form-->
        {!! Form::open(['url' => 'report/dn_map', 'method' => 'post', 'class' => 'm-form m-form--fit m-form--label-align-right body_form','autocomplete'=>'off' ]) !!}
        ...
        <div class="form-group m-form__group row">
            ...
            <div class="col-md-3">
                {!! Form::select('category_id', $categories, $category_id ,['class' => 'form-control', 'id'=>'specific_category']) !!}
    ...
    <script>
        ...
        mydata.push(['<?php echo $outlet->code_highmaps; ?>',
            <?php echo number_format($outlet->data_av, 2, ".", ","); ?>]);
        <?php
        }
        }
        ?>
