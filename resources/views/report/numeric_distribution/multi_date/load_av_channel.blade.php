...
if (!empty($report_data->toArray())) {
            ...
            <tbody>
                ...
                foreach ($components as $brand_name => $componentDates) {
                    ...
                    <tr>
                        ...
                        <?php foreach ($dates as $date) { ?>
                            <td class="av_row<?php echo $out_val; ?>">
                                <?php
                            ...
                            <td class="oos_row<?php echo $out_val; ?>">
                                <?php
    ...
    <br>
    <br>
    <div style="height:400px; width:100%;" id="chartHENKELalone<?php echo $out_val; ?>"></div>
    ...
    foreach ($clusters as $cluster) {
        ...
        <div class="m-portlet">
            ...
            <div class="m-portlet__body">
                <!--begin::Section-->
                <div class="m-section">
                    <div class="m-section__content" id="content_cluster<?php echo $cluster_id; ?>_<?php echo $out_val; ?>">
                        <script type="text/javascript">

                            var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
                            $('#content_cluster<?php echo $cluster_id; ?>_<?php echo $out_val; ?>').html('<div class="col-md-12" align="center"><img width="120px" src="<?php echo asset('img/Loader.gif'); ?>" class="img-responsive img-center" /></div>');
                            jQuery.ajax({
                                type: 'post',
...
?>
    ...
    Highcharts.chart('chartHENKELalone<?php echo $out_val; ?>', {
