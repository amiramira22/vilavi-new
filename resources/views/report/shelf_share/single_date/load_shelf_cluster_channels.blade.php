...
foreach ($report_data as $row) {
    ...
    $components[$row['product_group_id']][$channel] = [
        $row['shelf']
        , $row['brand_name']
        , $row['chapeau']
        , $row['yeux']
    ...
    $components_channel [$row['channel']][$row['product_group_id']] = $row['shelf'];
...
<div class="table-responsive">
    <table class="table table-bordered table-hover" id="myTable<?php echo $cluster_id; ?>">
        ...
        as $product_group_id => $componentchannels) {
        $i++;
        ?>
        <tr>
            <?php
            ...
            <td><?php echo $componentchannels[$channel][1]; ?></td>
            ...
            <td class="perc_brand<?php echo $cluster_id; ?>">
                ...
                if (isset($componentchannels[$channel])) {
                    ...
                    if ($sum_shelf_array[$channel] != 0) {
                        echo number_format(($componentchannels[$channel][0] / $sum_shelf_array[$channel]) * 100, 2);
                    } else {
                        echo '0';
                    }
            ...
            <td class="chapeau_brand<?php echo $cluster_id; ?>">
                ...
                if (isset($componentchannels[$channel])) {
                    //echo  ($componentDates[$channel][0]/ $sum_shelf_channel[$channel])*100 .'%';
                    if ($sum_chapeau_array[$channel] != 0) {
                        echo number_format(($componentchannels[$channel][2] / $sum_chapeau_array[$channel]) * 100, 2);
                    } else {
                        echo '0';
                    }
                    // echo $componentDates[$channel][0];
            ...
            <td class="yeux_brand<?php echo $cluster_id; ?>">
                ...
                if (isset($componentchannels[$channel])) {
                    //echo  ($componentDates[$channel][0]/ $sum_shelf_channel[$channel])*100 .'%';
                    if ($sum_yeux_array[$channel] != 0) {
                        echo number_format(($componentchannels[$channel][3] / $sum_yeux_array[$channel]) * 100, 2);
                    } else {
                        echo '0';
                    }
                    // echo $componentDates[$channel][0];
            ...
            <td class="main_brand<?php echo $cluster_id; ?>">
                ...
                if (isset($componentchannels[$channel])) {
                    //echo  ($componentDates[$channel][0]/ $sum_shelf_channel[$channel])*100 .'%';
                    if ($sum_main_array[$channel] != 0) {
                        echo number_format(($componentchannels[$channel][4] / $sum_main_array[$channel]) * 100, 2);
                    } else {
                        echo '0';
                    }
                    // echo $componentDates[$channel][0];
            ...
            <td class="pied_brand<?php echo $cluster_id; ?>">
                ...
                if (isset($componentchannels[$channel])) {
                    //echo  ($componentDates[$channel][0]/ $sum_shelf_channel[$channel])*100 .'%';
                    if ($sum_pied_array[$channel] != 0) {
                        echo number_format(($componentchannels[$channel][5] / $sum_pied_array[$channel]) * 100, 2);
                    } else {
                        echo '0';
                    }
                    // echo $componentDates[$channel][0];
