...
<div class="m-portlet m-portlet--tab">
    ...
    <!--begin::Form-->
    {!! Form::open(['url' => 'report/shelf_map', 'method' => 'post', 'class' => 'm-form m-form--fit m-form--label-align-right body_form','autocomplete'=>'off' ]) !!}
...
//********************************************************
    ...
    $('#specific_category').change(function () {
        ...
        $.ajax({
            type: "POST",
            url: '<?= route('report.get_data_for_shelf_maps_report') ?>',
