...
<div class="m-portlet m-portlet--tab">
    ...
    <!--begin::Form-->
    {!! Form::open(['url' => 'report/price_monotoring', 'method' => 'post', 'class' => 'm-form m-form--fit m-form--label-align-right','autocomplete'=>'off' ]) !!}
                ...
                <div class="m-portlet__body">
                    ...
                    <div class="m-section">
                        ...
                        <script type="text/javascript">
                            ...
                            jQuery.ajax({
                                type: 'post',
                                url: '<?= route('report.load_price_monotoring_per_cluster') ?>',
