                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="m_tabs_2" role="tabpanel">
                            <div class="m-scrollable m-scroller ps ps--active-y" data-scrollable="true"
                                ...
                                ?>
                                <div id="carouselExampleIndicators<?php echo $album[0]->outlet_id ?>"
                                    ...
                                    <ol class="carousel-indicators">
                                        ...
                                        <li data-target="#carouselExampleIndicators<?php echo $album[0]->outlet_id ?>"
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            ...
                                            <center>
                                                <img width="700px" height="350px"
                                                     src="{{ asset('uploads/outlet/'. $album[0]->outlet_picture) }}">
                                    ...
                                    <a class="carousel-control-prev"
                                       href="#carouselExampleIndicators<?php echo $album[0]->outlet_id ?>" role="button"
                                       data-slide="prev">
