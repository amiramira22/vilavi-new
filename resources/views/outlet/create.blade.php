                ...
                <div class="col-xl-8 offset-xl-2">
                    <div class="m-form__section m-form__section--first">
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-xl-9 col-lg-9">
                                {!! Form::text('longitude', null, ['class' => 'form-control m-input', 'placeholder' => 'Longitude']) !!}
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-xl-9 col-lg-9">
                                {!! Form::text('latitude', null, ['class' => 'form-control m-input', 'placeholder' => 'Latitude']) !!}
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-xl-9 col-lg-9">
                                {!! Form::select('sub_channel_id', $subChannels , null ,['class' => 'form-control ']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-xl-9 col-lg-9">
                                {!! Form::text('adress', null, ['class' => 'form-control m-input', 'placeholder' => 'Adresse']) !!}
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-xl-9 col-lg-9">
                                {!! Form::text('phone', null, ['class' => 'form-control m-input', 'placeholder' => 'Phone Number']) !!}
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-xl-9 col-lg-9">
                                {!! Form::text('contact', null, ['class' => 'form-control m-input', 'placeholder' => 'Contact']) !!}
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-xl-9 col-lg-9">
                                {!! Form::select('fo_id', $users , null ,['class' => 'form-control ']) !!}
                            </div>
                        </div>
                        <?php
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-xl-9 col-lg-9">
                                {!! Form::select('visit_day[]', $days , null ,['class' => 'form-control','id'=>'visit_day','multiple']) !!}
                            </div>
                        </div>
