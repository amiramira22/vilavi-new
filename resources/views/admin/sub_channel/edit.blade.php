...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="m-portlet">
            ...
            <!--begin::Form-->
            {!! Form::open(['url' => 'admin/sub_channel/postSubChannel', 'method' => 'post', 'class' => 'm-form m-form--label-align-righ']) !!}	

            <div class="m-portlet__body">
                <div class="col-xl-8 offset-xl-2">

                    <div class="m-form__section m-form__section--first">		
                        {!! Form::hidden('id', $subChannel->id) !!}

                        <div class="form-group m-form__group row">
                            <label class="col-xl-2 col-lg-2 col-form-label">Code</label>
                            <div class="col-xl-9 col-lg-9">
                                {!! Form::text('code',  $subChannel->code, ['class' => 'form-control m-input', 'placeholder' => 'Code']) !!}
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-xl-9 col-lg-9">
                                {!! Form::text('name', $subChannel->name, ['class' => 'form-control m-input', 'placeholder' => 'Name']) !!}
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-xl-9 col-lg-9">
                                {!! Form::select('channel_id', $channels,$subChannel->channel->name ,['class' => 'form-control ']) !!}
                                {!! $errors->first('channel_id', '<small class="help-block">:message</small>') !!}
                            </div>
                        </div>
