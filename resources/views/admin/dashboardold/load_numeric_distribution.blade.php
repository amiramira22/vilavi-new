...
//                    if ($brand->name == 'Main-Brand') {
                    ...
                    <script type="text/javascript">
                        ...
                        $("#numeric_distribution<?php echo $brand->id; ?>").click(function () {
                            ...
                            jQuery.ajax({
                                url: '<?= route('admin.dashboard.load_chart_numeric_distribution') ?>',
...
// Themes end
    ...
    var chart = am4core.create("numeric_distribution_chart_div_<?php echo env('brand_id'); ?>", am4charts.PieChart);
