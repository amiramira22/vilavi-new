...
if (!empty($report_data->toArray())) {
    ...
    <br>
    <br>
    <div style="height:350px; width:100%;" id="trend_zone<?php echo $zone_id; ?>"></div>
    <br>
    <br>
    <br>
    <br>
    ...
    foreach ($clusters as $cluster) {
        ...
        <div class="m-portlet">
            ...
            <div class="m-portlet__body">
                <!--begin::Section-->
                <div class="m-section">
                    <div class="m-section__content" id="content_cluster<?php echo $cluster_id; ?>-<?php echo $zone_id; ?>">
                        <script type="text/javascript">
                            var channel_ids = JSON.stringify(<?php echo $json_channel_ids; ?>);
                            var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
                            $('#content_cluster<?php echo $cluster_id; ?>-<?php echo $zone_id; ?>').html('<div class="col-md-12" align="center"><img width="120px" src="<?php echo asset('img/Loader.gif'); ?>" class="img-responsive img-center" /></div>');
                            jQuery.ajax({
                                type: 'post',
                                ...
                                success: function (data) {
                                    $('#content_cluster<?php echo $cluster_id; ?>-<?php echo $zone_id; ?>').html(data);
                                }
                            });
                        </script>
                    </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('tr').each(function () {
            ...
            $('.total-perc_row<?php echo $zone_id; ?>', this).html(parseFloat(sum_shelf_perc / n_shelf_perc).toFixed(2));
        }); // End foreach TR
    });
</script>
...
?>
    ...
    Highcharts.chart('trend_zone<?php echo $zone_id; ?>', {
