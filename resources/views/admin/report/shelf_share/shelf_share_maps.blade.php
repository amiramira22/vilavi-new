...
<div class="m-portlet m-portlet--tab">
    ...
    <!--begin::Form-->
    {!! Form::open(['url' => 'admin/report/shelf_map', 'method' => 'post', 'class' => 'm-form m-form--fit m-form--label-align-right body_form','autocomplete'=>'off' ]) !!}
                                    ...
                                    <center>
                                        ...
                                        if ($channel_id == -1) {
                                            foreach ($channels_badge as $ch) {
                                                ?>
                                                <span class="m-badge m-badge--<?php echo $ch->template_color ?> m-badge--wide  width-150px"><?php echo $ch->name ?></span>
                                                <?php
                                            }
                                        } else {
                                            ...
                                            <span class="m-badge m-badge--<?php echo $channel_color ?> m-badge--wide  width-150px"><?php echo $channel_name ?></span>
                                        <?php } ?>
...
//********************************************************
    ...
    $('#specific_category').change(function () {
        ...
        $.ajax({
            type: "POST",
            url: '<?= route('admin.report.get_data_for_shelf_maps_report') ?>',
...
if (isset($outlets_for_map_two)) {
    foreach ($outlets_for_map_two as $outlet) {
        ?>
            mydata.push(['<?php echo $outlet->code_highmaps; ?>',<?php echo number_format($outlet->shelf_perc * 100, 2, ',', ' '); ?>]);
        <?php
    }
}
?>
