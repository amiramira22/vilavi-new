...
<div class="m-portlet m-portlet--tab">
    ...
    <!--begin::Form-->
    {!! Form::open(['url' => 'admin/report/extarait_pdv_shelf_share_report', 'method' => 'post', 'class' => 'm-form m-form--fit m-form--label-align-right','autocomplete'=>'off' ]) !!}
            ...
            $(window).scroll(function () {
                ...
                if ((position == bottom) || ((position + 1) == bottom)) {
                    ...
                    if (row <= allcount) {
                        ...
                        $.ajax({
                            type: 'post',
                            url: '<?= route('admin.report.load_extarait_pdv_shelf_share_per_category') ?>',
