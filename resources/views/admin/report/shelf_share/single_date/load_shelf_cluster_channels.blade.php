...
foreach ($report_data as $row) {
    ...
    $components[$row['product_id']][$channel] = $row['shelf'];
    $components_channel [$row['channel']] [$row['product_id']] = $row['shelf'];
                    ...
                    <?php foreach ($channels as $channel) { ?>
                        <td class="shelf_brand<?php echo $cluster_id; ?>">
                            ...
                            if (isset($componentChannels[$channel])) {
                                echo $componentChannels[$channel];
                            } else
                                echo '-';
                            ?> </td>
                        ...
                        <td class="perc_brand<?php echo $cluster_id; ?>">
                            ...
                            if (isset($componentChannels[$channel])) {
                                ...
                                if ($sum_shelf_array[$channel] != 0) {
                                    echo number_format(($componentChannels[$channel] / $sum_shelf_array[$channel]) * 100, 2);
                                } else {
                                    echo '0';
                                }
