...
<div class="m-portlet m-portlet--tab">
    ...
    <!--begin::Form-->
    {!! Form::open(['url' => 'admin/report/shelf_share', 'method' => 'post', 'class' => 'm-form m-form--fit m-form--label-align-right','autocomplete'=>'off' ]) !!}
...
@include('admin.report.shelf_share.multi_date.multi_date');

@elseif  ($multi_date && $multi_zone) 
@include('admin.report.shelf_share.multi_date.multi_date_zones');

@elseif  ($multi_date && !$multi_zone && $multi_channel)
@include('admin.report.shelf_share.multi_date.multi_date_channels');

@elseif  (!$multi_date && !$multi_zone && !$multi_channel)
@include('admin.report.shelf_share.single_date.single_date');

@elseif  (!$multi_date && $multi_zone)
@include('admin.report.shelf_share.single_date.single_date_zones');

@elseif  (!$multi_date && $multi_channel)
@include('admin.report.shelf_share.single_date.single_date_channels');
