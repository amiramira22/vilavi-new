                ...
                <div class="m-section">
                    <div class="m-section__content" id="content_cluster<?php echo $cluster_id; ?>-1">
                        <script type="text/javascript">
                            ...
                            jQuery.ajax({
                                type: 'post',
                                url: '<?= route('admin.report.load_av_cluster_zones') ?>',
...
foreach ($zone_components as $zone => $componentBrands) {
    ...
    <div class="m-portlet">
        ...
        <div class="m-portlet__body">
            <!--begin::Section-->
            <div class="m-section">
                <div class="m-section__content" style="height:380px; width:100%;" id="chart_zone<?php echo $zone; ?>">
    ...
    <script>
        ...
        var chart = Highcharts.chart("chart_zone<?php echo $zone; ?>", {
