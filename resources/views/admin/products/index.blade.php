...
<div class="m-portlet m-portlet--mobile">
        ...
        <div class="m-portlet__head-tools">
            <ul class="m-portlet__nav">
                <li class="m-portlet__nav-item">
                    <a href="{{ route('admin.product.create') }}" class="btn btn-outline-primary m-btn m-btn--custom m-btn--icon m-btn--outline-2x m-btn--pill m-btn--air">
                        <span>
                            <i class="fas fa-cart-plus"></i>
                                    <span> @lang('project.NEW')  @lang('project.PRODUCT')</span>
                        </span>
                    </a>
                </li>
    ...
    <div class="m-portlet__body">
        ...
        <div class="table-responsive">
            <table class="table table-striped- table-bordered table-hover table-checkable"  id="product_tab">
                <thead>
                    <tr>
                        <th> image </th>
                        <th> Code </th>
...
<script>
    $(document).ready(function () {
        var table = $('#product_tab').DataTable({
            processing: true,
            serverSide: true,
            iDisplayLength: 20,
