...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="m-portlet">
            ...
            <!--begin::Form-->
            {!! Form::open(['url' => 'admin/product/postProduct', 'method' => 'post', 'class' => 'm-form m-form--label-align-righ', 'enctype' => 'multipart/form-data']) !!}	
            ...
            <div class="m-portlet__body">
                <div class="col-xl-8 offset-xl-2">
                    ...
                    <div class="m-form__section m-form__section--first">		
                        ...
                        <div class="form-group m-form__group row">
                            <label class="col-xl-2 col-lg-2 col-form-label">Product</label>
                            <div class="col-xl-9 col-lg-9">
                        ...
                        <div class="form-group m-form__group row">
                            <label class="col-xl-2 col-lg-2 col-form-label">Product Group</label>
                            <div class="col-xl-9 col-lg-9">
                                {!! Form::select('product_group_id', $productgroups, null ,['class' => 'form-control ']) !!}

                            </div>
                        </div>

                        <div class="form-group m-form__group row">
                            <label class="col-xl-2 col-lg-2 col-form-label">Brand</label>
                            <div class="col-xl-9 col-lg-9">
