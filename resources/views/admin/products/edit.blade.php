...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="m-portlet">
            ...
            <!--begin::Form-->
            {!! Form::open(['url' => 'admin/product/postProduct', 'method' => 'post', 'class' => 'm-form m-form--label-align-righ']) !!}	
                    ...
                    <div class="m-form__section m-form__section--first">		
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-xl-9 col-lg-9">
                                {!! Form::text('code',  $product->code, ['class' => 'form-control m-input', 'placeholder' => 'Code']) !!}
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-xl-9 col-lg-9">
                                {!! Form::text('name', $product->name, ['class' => 'form-control m-input', 'placeholder' => 'Name']) !!}
                                {!! $errors->first('name', '<small class="help-block">:message</small>') !!}
                            </div>
                        </div>	

                        <div class="form-group m-form__group row">
                            <label class="col-lg-2 col-form-label">Product Group</label>
                            <div class="col-xl-9 col-lg-9">
                                {!! Form::select('product_group_id', $productgroups,$product->productGroup->name ,['class' => 'form-control ']) !!}
                                {!! $errors->first('product_group_id', '<small class="help-block">:message</small>') !!}
                            </div>
                        </div>
                        <div class="form-group m-form__group row">
                            <label class="col-lg-2 col-form-label">Brnad</label>
                            <div class="col-xl-9 col-lg-9">
                                {!! Form::select('brand_id', $brands,$product->brand->name ,['class' => 'form-control ']) !!}
