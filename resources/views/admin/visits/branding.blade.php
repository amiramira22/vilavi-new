                    ...
                    <div id="carouselExampleIndicators<?php echo $row->id ?>" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                ...
                                <table>
                                    <tr>
                                        <td width="5%"></td>
                                        <td width="100%">
                                            <img width="700px" height="350px" src="https://bcm.cap.tn/uploads/outlet/{{$row->outlet_picture}}"  >
                                        </td>
                                        <td width="5%"></td>
                                    </tr>
                                </table>
                            ...
                            <div class="carousel-item">
                                ...
                                <table>
                                    <?php
                                    $filename = "https://bcm.cap.tn/uploads/branding.old/" . $branding_pictures[0][0];
                                    ...
                                    if (($file_headers[0] == 'HTTP/1.1 404 Not Found') || ($file_headers[0] == 'HTTP/1.0 302 Found')) {
                                        ...
                                        <tr>
                                            <td width="5%"></td>
                                            <td width="50%"><span><img src="https://bcm.cap.tn/uploads/branding/{{$branding_pictures[0][0]}}" width="300px" height="350px" alt="admin-pic" download></span></td>
                                            <td width="5%"></td>
                                            <td width="50%"> <span><img src="https://bcm.cap.tn/uploads/branding/{{$branding_pictures[0][1]}}" width="300px" height="350px" alt="admin-pic" download></span></td>
                                            <td width="5%"></td>
                                        </tr>
                                    <?php } else { ?>
                                        <tr>
                                            <td width="5%"></td>
                                            <td width="50%"><span><img src="https://bcm.cap.tn/uploads/branding.old/{{$branding_pictures[0][0]}}" width="300px" height="350px" alt="admin-pic" download></span></td>
                                            <td width="5%"></td>
                                            <td width="50%"> <span><img src="https://bcm.cap.tn/uploads/branding.old/{{$branding_pictures[0][1]}}" width="300px" height="350px" alt="admin-pic" download></span></td>
                                            <td width="5%"></td>
                                        </tr>
                                    <?php } ?>
                                </table>
                            ...
                            for ($i = 1; $i < $size_pictures; $i++) {
                                ...
                                <div class="carousel-item">
                                    <table>
                                        ...
                                        <?php
                                        $filename1 = "https://bcm.cap.tn/uploads/branding.old/" . $branding_pictures[$i][0];
                                        $file_headers1 = @get_headers($filename1);
                                        //print_r($file_headers);
                                        if (($file_headers1[0] == 'HTTP/1.1 404 Not Found') || ($file_headers1[0] == 'HTTP/1.0 302 Found')) {
                                            ?>
                                            <tr>
                                                <td width="5%"></td>
                                                <td width="50%"><span><img src="https://bcm.cap.tn/uploads/branding/{{$branding_pictures[$i][0]}}" width="300px" height="350px" alt="admin-pic" download></span></td>
                                                <td width="5%"></td>
                                                <td width="50%"> <span><img src="https://bcm.cap.tn/uploads/branding/{{$branding_pictures[$i][1]}}" width="300px" height="350px" alt="admin-pic" download></span></td>
                                                <td width="5%"></td>
                                            </tr>
                                        <?php } else { ?>
                                            <tr>
                                                <td width="5%"></td>
                                                <td width="50%"><span><img src="https://bcm.cap.tn/uploads/branding.old/{{$branding_pictures[$i][0]}}" width="300px" height="350px" alt="admin-pic" download></span></td>
                                                <td width="5%"></td>
                                                <td width="50%"> <span><img src="https://bcm.cap.tn/uploads/branding.old/{{$branding_pictures[$i][1]}}" width="300px" height="350px" alt="admin-pic" download></span></td>
                                                <td width="5%"></td>
                                            </tr>
                                        <?php } ?>
