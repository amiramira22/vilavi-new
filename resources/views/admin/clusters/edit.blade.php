...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="m-portlet">
            ...
            <!--begin::Form-->
            {!! Form::open(['url' => 'admin/cluster/postCluster', 'method' => 'post', 'class' => 'm-form m-form--label-align-righ']) !!}	
                    ...
                    <div class="m-form__section m-form__section--first">		
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-xl-9 col-lg-9">
                                {!! Form::text('code',  $cluster->code, ['class' => 'form-control m-input', 'placeholder' => 'Code']) !!}
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-xl-9 col-lg-9">
                                {!! Form::text('name', $cluster->name, ['class' => 'form-control m-input', 'placeholder' => 'Name']) !!}
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-xl-9 col-lg-9">
                                {!! Form::select('sub_category_id', $subcategories,$cluster->subCategory->name ,['class' => 'form-control ']) !!}
                                {!! $errors->first('sub_category_id', '<small class="help-block">:message</small>') !!}
                            </div>
                        </div>
