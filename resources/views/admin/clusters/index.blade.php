...
<div class="m-portlet m-portlet--mobile">
        ...
        <div class="m-portlet__head-tools">
            <ul class="m-portlet__nav">
                <li class="m-portlet__nav-item">
                    <a href="{{ route('admin.cluster.create') }}" class="btn btn-outline-primary m-btn m-btn--custom m-btn--icon m-btn--outline-2x m-btn--pill m-btn--air">
                        <span>
                            <i class="fas fa-cart-plus"></i>
                            <span> @lang('project.NEW')  @lang('project.CLUSTER')</span>
                        </span>
                    </a>
                </li>
    ...
    <div class="m-portlet__body">
        ...
        <table class="table table-striped- table-bordered table-hover table-checkable"  id="cluster_tab">
            <thead>
                <tr>
                    <th> Code </th>
                    <th> Cluster </th>
...
<script>
    $(document).ready(function () {
        var table = $('#cluster_tab').DataTable({
            processing: true,
            serverSide: true,
            iDisplayLength: 20,

            ajax: {
                "url": "<?= route('admin.cluster.getClusters') ?>",
                "dataType": "json",
                "type": "POST",
