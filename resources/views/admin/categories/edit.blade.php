...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="m-portlet">
            ...
            <!--begin::Form-->
            {!! Form::open(['url' => 'admin/category/postCategory', 'method' => 'post', 'class' => 'm-form m-form--label-align-righ']) !!}	
                    ...
                    <div class="m-form__section m-form__section--first">		
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-xl-9 col-lg-9">
                                {!! Form::text('code',  $category->code, ['class' => 'form-control m-input', 'placeholder' => 'Code']) !!}
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-xl-9 col-lg-9">
                                {!! Form::text('name', $category->name, ['class' => 'form-control m-input', 'placeholder' => 'Name']) !!}
