...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="m-portlet">
            ...
            <!--begin::Form-->
            {!! Form::open(['url' => 'admin/brand/postBrand', 'method' => 'post', 'class' => 'm-form m-form--label-align-righ']) !!}	
                    ...
                    <div class="m-form__section m-form__section--first">		
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-xl-9 col-lg-9">
                                {!! Form::text('code',  $brand->code, ['class' => 'form-control m-input', 'placeholder' => 'Code']) !!}
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-xl-9 col-lg-9">
                                {!! Form::text('name', $brand->name, ['class' => 'form-control m-input', 'placeholder' => 'Name']) !!}
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-xl-9 col-lg-9">
                                {!! Form::color('color', $brand->color, ['class' => 'form-control m-input', 'placeholder' => 'Color']) !!}
