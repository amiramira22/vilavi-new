...
class CronJobController extends Controller
{
    ...
    public function update_ha_avialibility($start_date = null)
    {
        ...
        $query = DB::table('models')->select('
            ...
            'models.av as av',
            'ha.product_id as ha_product_id',
            'models.product_id as models_product_id',
            'visits.outlet_id as visited_outlet_id',
            'ha.outlet_id as ha_outlet_id'

        )
            ->join('visits', 'models.visit_id', '=', 'visits.id')
            ->leftjoin('ha', 'models.product_id', '=', 'ha.product_id')
            ->leftjoin('ha', 'visits.outlet_id', '=', 'ha.outlet_id')
