...
//            dd($fos);
        ...
        foreach ($today_visits as $visit) {
            ...
            $content = '<b>Outlet name:</b> ' . $visit->outlet_name
                    ...
                    . ' </br><b>Show outlet details:</b> <a class="m--font-red red filter-submit margin-bottom" href="' . url('admin/outlet/view/' . $visit->outlet_id) . '  " data-toggle="tooltip" data-placement="top" title="Outlet details" target="_blank"><i class="fas fa-map-o"></i></a>'
                    . ' </br><b>Show visit details:</b><a class="m--font-info green filter-submit margin-bottom" href="' . url('admin/visit/report/' . $visit->visit_id) . ' " data-toggle="tooltip" data-placement="top" title="Visit details" target="_blank"><i class="fas fa-map-o"></i></a>';
    ...
    function load_oos_peer_channel() {
        ...
        return view('admin.dashboard.load_oos_per_channel', $data);
    }
    ...
    function load_chart_oos_per_channel(Request $request) {
        ...
        return view('admin.dashboard.chart_oos_per_channel', $data);
    }
    ...
    function load_oos_peer_category() {
        ...
        return view('admin.dashboard.load_oos_per_category', $data);
    }
    ...
    function load_chart_oos_per_category(Request $request) {
        ...
        //dd( $data['oos_per_category_data']);
        return view('admin.dashboard.chart_oos_per_category', $data);
    }
    ...
    function load_numeric_distribution(Request $request) {
        ...
        return view('admin.dashboard.load_numeric_distribution', $data);
    }
    ...
    function load_chart_numeric_distribution(Request $request) {
        ...
        $data['numeric_distribution_data'] = $this->dashboardRepository->get_data_numeric_distribution($brand_id, $date);
        //dd( $data['numeric_distribution_data']);
        return view('admin.dashboard.chart_numeric_distribution', $data);
    }
    ...
    function load_top_5_oos() {
        ...
        return view('admin.dashboard.load_top_5_oos', $data);
    }
    ...
    function load_top_oos_products(Request $request) {
        ...
        return view("admin.dashboard.dashboard_top_oos_products_peer_week", $data);
    }
    ...
    function top_oos_all_products($date) {
        ...
        return view("admin.dashboard.top_oos_all_products", $data);
    }
    ...
    function load_oos_trend() {
        ...
        return view("admin.dashboard.load_oos_trend", $data);
    }
    ...
    function load_chart_oos_trend(Request $request) {
        ...
        $data['components'] = $result['components'];
        $data['dates'] = $result['dates'];
        return view("admin.dashboard.chart_oos_trend", $data);
    }
    ...
    function outlets_details() {
        ...
        return view("admin.dashboard.outlets_details", $data);
    }
    ...
    function daily_details(Request $request) {
        ...
        return view("admin.dashboard.daily_details", $data);
    }
    ...
    function monthly_details(Request $request) {
        ...
        return view("admin.dashboard.monthly_details", $data);
    }
